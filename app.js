...
async function renderRegistroEditor(mesocycleId) {
  ...
  registroEditor.append(dayContainer, registeredExercisesContainer);
  ...
  saveBtn.onclick = async () => {
    if (!selectedDay || !exerciseSelect.value) {
      alert("Selecciona día y ejercicio");
      return;
    }
